...
const experiences = [
  ...
  },
  {
    ...
    points: [
      "Designing visually appealing and interactive website layouts using Webflow's visual editor, custom animations, and effects to enhance user experience.",
      "Developing responsive web pages with cross-browser and cross-device compatibility, integrating third-party services and APIs, and optimizing website performance and loading speed.",
      "Collaborating with designers and stakeholders to implement design visions, providing maintenance and support for existing Webflow websites, and staying updated on the latest web design trends and best practices.",
    ],
  },
  {
